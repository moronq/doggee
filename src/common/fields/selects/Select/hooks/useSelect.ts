...
export const useSelect = ({ options, value, filterOption, onChange }: UseSelectParams) => {
  ...
  // Logic for pressing key up/down/enter for select
  ...
  return {
    ...
    state: { filteredOptions, showOptions, searchSelectedOption, value, inputValue }
  }
}
